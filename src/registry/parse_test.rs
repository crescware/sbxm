...
fn parsed(text: &str) -> Registry {
    parse(text, Path::new("/home/user/.sbxm/registry.yaml")).expect("the document parses")
}

fn refused(text: &str) -> Error {
    parse(text, Path::new("/home/user/.sbxm/registry.yaml")).expect_err("the document is refused")
}

#[test]
fn a_document_without_entries_holds_no_project() {
...
#[test]
fn an_entry_is_read_back_as_the_repository_it_names() {
...
#[test]
fn entries_come_back_in_canonical_order_whatever_order_they_were_written_in() {
...
#[test]
fn an_unknown_version_is_diagnosed_before_the_entries() {
...
#[test]
fn a_field_that_disagrees_with_the_clone_url_is_refused() {
    for (field, value) in [
...
#[test]
fn a_project_root_that_is_not_an_absolute_path_is_refused() {
...
#[test]
fn a_field_the_document_never_defines_is_refused_rather_than_ignored() {
