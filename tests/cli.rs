...
const COMMANDS: [&str; 12] = [
    "add", "apply", "files", "sync", "guide", "repair", "rebuild", "open", "stop", "ls", "status",
    "destroy",
];
...
const CONFIGURED_COMMANDS: [&str; 4] = ["repair", "rebuild", "open", "sync"];
...
const PROJECT_COMMANDS: [&str; 6] = ["repair", "rebuild", "open", "stop", "destroy", "sync"];
