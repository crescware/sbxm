...
const COMMANDS: [&str; 13] = [
    "add", "apply", "files", "fetch", "send", "guide", "repair", "rebuild", "open", "stop", "ls",
    "status", "destroy",
];
...
const CONFIGURED_COMMANDS: [&str; 5] = ["repair", "rebuild", "open", "fetch", "send"];
...
const PROJECT_COMMANDS: [&str; 7] = [
    "repair", "rebuild", "open", "stop", "destroy", "fetch", "send",
];
