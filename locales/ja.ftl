...
github-token-scopes = 対象repositoryに限定したfine-grained personal access tokenを発行します。権限はContents read/writeとMetadata read。必要な場合だけPull requests、Issues、Actionsを追加します。
