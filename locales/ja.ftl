...
cause-source-unreadable = sourceを読み取れません: { $detail }
...
cause-archive-unopenable = archiveを開けません: { $detail }
cause-archive-unreadable = archiveを読み取れません: { $detail }
cause-archive-unscannable = archiveを走査できません: { $detail }
...
cause-archive-entry-unreadable = { $entry } を読み取れません: { $detail }
