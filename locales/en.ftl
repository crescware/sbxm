...
github-token-scopes = Issue a fine-grained personal access token limited to this repository. Permissions: Contents read and write, Metadata read. Add Pull requests, Issues or Actions only if you need them.
