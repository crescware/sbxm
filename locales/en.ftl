...
error-origin-upstream-missing = The branch { $reference } has no upstream, so its commits exist only inside the sandbox.
error-origin-commit-unpushed = { $reference } holds { $count } commits that { $upstream } does not have.
