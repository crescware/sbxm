...
remediation-origin-object-missing = Recover the missing commit from the origin or a backup, for example with a read-only `git fsck --full`, then run this command again once it is present.
