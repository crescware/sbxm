...
error-no-local-projects = There is no project added with --local to choose from.
...
remediation-no-local-projects = Add a Git repository on this host with --local first.
