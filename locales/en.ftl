...
error-initial-provisioning-pending = { $project } has an unfinished first-provisioning intent, so prepare will not resume it implicitly.
...
repair-action-no-change = No mutation: the project is already fresh or ready; use prepare or open as appropriate.
