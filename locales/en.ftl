...
status-files-modified-note = Some declared files were changed inside the sandbox. apply --files leaves them alone; save what you need before replacing them with --force.
