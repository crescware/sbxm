...
remediation-github-credential-rejected = { github-token-scopes } Check that the token is still valid and still reaches this repository. Register it again, then run the same command again.
