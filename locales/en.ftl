...
guidance-next-repair-pending = The first provisioning started and did not finish; open resumes its recorded generation and connects.
guidance-next-repair-incomplete = Part of the connection-ready state is missing; open restores what it can verify and connects.
