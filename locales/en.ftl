...
error-global-state-unusable = The global state directory { $path } cannot be used: { $detail }
error-working-directory-unusable = The directory { $path } cannot hold a project: { $detail }
