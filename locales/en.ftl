...
cli-files-action-help = What to do: add a declaration, ls to list them, or rm to remove one
cli-files-path-help = For add, the host file to declare; for rm, the destination of the declaration to remove
...
status-files-modified-note = Some declared files were changed inside the sandbox. Placing the declared files again leaves them alone; save what you need before forcing a replacement.
