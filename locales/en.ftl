...
cause-source-unreadable = the source could not be read: { $detail }
...
cause-archive-unopenable = the archive could not be opened: { $detail }
cause-archive-unreadable = the archive could not be read: { $detail }
cause-archive-unscannable = the archive could not be scanned: { $detail }
...
cause-archive-entry-unreadable = { $entry } could not be read: { $detail }
