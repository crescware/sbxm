...
| [`send`](./send/) | Send the host repository's branches and tags to the sandbox of a project added with `--local` |
| [`sync`](./sync/) | Sync the host repository and the sandbox of a project added with `--local`, by Git's own rules |
