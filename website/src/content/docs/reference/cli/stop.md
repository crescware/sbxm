...
For a project added with `--local`, a running sandbox's commits are saved into the host repository before it stops; see [Develop without GitHub](../../../guides/local-repository/#automatic-fetch).
